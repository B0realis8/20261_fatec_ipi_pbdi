...
DROP PROCEDURE IF EXISTS sp_acha_maior;
-- criando
CREATE OR REPLACE PROCEDURE sp_acha_maior (INOUT valor1 INT, IN valor2 INT, IN valor3 INT)
LANGUAGE plpgsql
AS $$
BEGIN
...
DECLARE
    ...
    valor2 INT := 3;
BEGIN
    CALL sp_acha_maior(valor1, valor2, 4); -- o valor 1 entra, é atualizado e retorna com o novo valor
    RAISE NOTICE '% é o maior', valor1; -- aqui ele retorna o valor da variavel valor1 atualizada
    RAISE NOTICE '% é o maior', valor2; -- aqui ele retorna o valor da variavel valor2 como foi declarada, pois é apenas IN
END;
$$;